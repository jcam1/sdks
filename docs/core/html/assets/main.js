  ...
  var je = (t, e, n, r) => {
    if ((e && typeof e == 'object') || typeof e == 'function')
      for (let i of Fe(e))
        !Be.call(t, i) &&
          i !== n &&
          ae(t, i, { get: () => e[i], enumerable: !(r = Ae(e, i)) || r.enumerable });
    return t;
  };
  var qe = (t, e, n) => (
    (n = t != null ? De(Ne(t)) : {}),
    je(e || !t || !t.__esModule ? ae(n, 'default', { value: t, enumerable: !0 }) : n, t)
  );
  var he = Ve((ue, de) => {
    (function () {
      var t = function (e) {
...
`,
        ...
        var e = {
          ...
          N = function (u) {
            ...
            if (
              ...
              var E = h.exec(u);
              (h = m), h.test(E[1]) && ((h = b), (u = u.replace(h, '')));
            } else if (x.test(u)) {
              var E = x.exec(u);
              (g = E[1]),
                (x = v),
            ...
            if (((h = F), (x = $), h.test(u))) {
              var E = h.exec(u);
              (g = E[1]), (h = f), h.test(g) && (u = g);
            } else if (x.test(u)) {
              var E = x.exec(u);
              (g = E[1] + E[2]), (x = f), x.test(g) && (u = g);
            }
            if (((h = Q), h.test(u))) {
              var E = h.exec(u);
              (g = E[1]),
            ...
            return (
              (h = z),
              (x = f),
              h.test(u) && x.test(u) && ((h = b), (u = u.replace(h, ''))),
          ...
          for (var r = new t.TokenSet(), i = [{ node: r, editsRemaining: n, str: e }]; i.length; ) {
            ...
            if (s.editsRemaining != 0) {
              ...
              if (s.str.length > 1) {
                ...
                m in s.node.edges
                  ? (f = s.node.edges[m])
                  : ((f = new t.TokenSet()), (s.node.edges[m] = f)),
          ...
          for (
            ...
            for (
              ...
              for (var d = s[c], m = 0; m < l; m++) {
                var f = a[m];
                if (f == d || d == '*') {
                  var L = r.node.edges[f],
                    v = r.qNode.edges[d],
                    w = L.final && v.final,
                    p = void 0;
                  f in r.output.edges
                    ? ((p = r.output.edges[f]), (p.final = p.final || w))
                    : ((p = new t.TokenSet()), (p.final = w), (r.output.edges[f] = p)),
                    i.push({ qNode: v, output: p, node: L });
                }
              }
          }
          return n;
      ...
      (t.Index = function (e) {
        ...
        (t.Index.prototype.query = function (e) {
          ...
          for (var l = 0; l < n.clauses.length; l++) {
            ...
            for (var f = 0; f < d.length; f++) {
              ...
              var v = t.TokenSet.fromClause(c),
                w = this.tokenSet.intersect(v).toArray();
              if (w.length === 0 && c.presence === t.Query.presence.REQUIRED) {
              ...
              for (var S = 0; S < w.length; S++)
                for (
                  var b = w[S], k = this.invertedIndex[b], _ = k._index, p = 0;
                  p < c.fields.length;
                  p++
                ) {
                  var y = c.fields[p],
                  ...
                  if (
                    (i[y].upsert(_, c.boost, function (Re, He) {
                      return Re + He;
                    }),
                    !s[j])
                  ) {
                    for (var F = 0; F < A.length; F++) {
                      var $ = A[F],
                        ...
                        z = V[$],
                        W;
                      (W = r[Q]) === void 0 ? (r[Q] = new t.MatchData(b, y, z)) : W.add(b, y, z);
                    }
                    s[j] = !0;
                  }
                }
          ...
          for (var N = t.Set.complete, M = t.Set.empty, l = 0; l < this.fields.length; l++) {
            var y = this.fields[l];
            o[y] && (N = N.intersect(o[y])), a[y] && (M = M.union(a[y]));
          }
          var u = Object.keys(r),
            g = [],
          ...
          return g.sort(function (_e, Me) {
            return Me.score - _e.score;
          });
        }),
      ...
      (t.Builder = function () {
        ...
        (t.Builder.prototype.add = function (e, n) {
          ...
          for (var s = 0; s < i.length; s++) {
            ...
            (this.fieldTermFrequencies[m] = f),
              (this.fieldLengths[m] = 0),
              (this.fieldLengths[m] += d.length);
            for (var L = 0; L < d.length; L++) {
              var v = d[L];
              if ((f[v] == null && (f[v] = 0), (f[v] += 1), this.invertedIndex[v] == null)) {
                var w = Object.create(null);
                (w._index = this.termIndex), (this.termIndex += 1);
                for (var p = 0; p < i.length; p++) w[i[p]] = Object.create(null);
                this.invertedIndex[v] = w;
              }
              ...
              for (var y = 0; y < this.metadataWhitelist.length; y++) {
                ...
                this.invertedIndex[v][o][r][S] == null && (this.invertedIndex[v][o][r][S] = []),
                  this.invertedIndex[v][o][r][S].push(b);
              }
            }
          }
        }),
          ...
          for (
            ...
            for (
              ...
              var p = m[w],
                ...
                _;
              i[p] === void 0
                ? ((b = t.idf(this.invertedIndex[p], this.documentCount)), (i[p] = b))
                : (b = i[p]),
                (k =
                  (b * ((this._k1 + 1) * y)) /
    ...
    n.addEventListener(
      ...
      n.addEventListener('keydown', (i) => {
        i.key == 'Enter'
          ? Ue(e, t)
          : i.key == 'ArrowUp'
            ? (pe(e, n, -1), i.preventDefault())
            : i.key === 'ArrowDown' && (pe(e, n, 1), i.preventDefault());
      }),
  ...
  function Ue(t, e) {
    ...
    if ((n || (n = t.querySelector('li:first-child')), n)) {
      ...
      r && (window.location.href = r.href), ne(e);
    }
  }
  function me(t, e) {
    if (e === '') return t;
    let n = t.toLocaleLowerCase(),
      ...
      o = n.indexOf(r);
    for (; o != -1; )
      i.push(te(t.substring(s, o)), `<b>${te(t.substring(o, o + r.length))}</b>`),
        (s = o + r.length),
        (o = n.indexOf(r, s));
  ...
  Ee &&
    ...
    ((Ge = !0), (H = 'touchstart'), (xe = 'touchmove'), (B = 'touchend'));
  ...
  document.addEventListener('click', (t) => {
    ve && (t.preventDefault(), t.stopImmediatePropagation(), (ve = !1));
  });
  ...
  var C = ie;
  var we = document.head.appendChild(document.createElement('style'));
  we.dataset.for = 'filters';
  var Y = class extends I {
    ...
    constructor(e) {
      super(e),
        ...
        (we.innerHTML += `html:not(.${this.key}) .tsd-is-${this.el.name} { display: none; }
`),
    ...
    Z = class extends I {
      constructor(e) {
        ...
        let i = `tsd-accordion-${n.dataset.key ?? n.textContent.trim().replace(/\s+/g, '-').toLowerCase()}`,
          s;
        if (se.has(i)) s = se.get(i);
        else {
          let o = C.getItem(i),
            a = o ? o === 'true' : this.el.open;
          (s = new oe(i, a)), se.set(i, s);
        }
        s.add(this.el);
      }
    };
  function be(t) {
    ...
    (t.value = e),
      ...
      t.addEventListener('change', () => {
        C.setItem('tsd-theme', t.value), Le(t.value);
      });
  }
  function Le(t) {
  ...
  function ke() {
    ...
    t && (t.addEventListener('load', Se), Se());
  }
  async function Se() {
    ...
    let n = await (await fetch(window.navigationData)).arrayBuffer(),
      ...
      i = await new Response(r).json();
    (K = document.documentElement.dataset.base), K.endsWith('/') || (K += '/'), (t.innerHTML = '');
    for (let s of i) Ce(s, t, []);
  ...
  function Ce(t, e, n) {
    ...
    if (t.children) {
      ...
      for (let c of t.children) Ce(c, l, i);
    } else Te(t, r, t.class);
  }
  function Te(t, e, n) {
    if (t.path) {
  ...
  var ee = document.documentElement.dataset.base;
  ee.endsWith('/') || (ee += '/');
  function Qe() {
    document.querySelector('.tsd-full-hierarchy')
      ? Xe()
      : document.querySelector('.tsd-hierarchy') && Ye();
  }
  function Xe() {
  ...
  function Ye() {
    ...
    t && (t.addEventListener('load', Ie), Ie());
  }
  async function Ie() {
    let t = document.querySelector('.tsd-panel.tsd-hierarchy:has(h4 a)');
    if (!t || !window.hierarchyData) return;
    let n = await (await fetch(window.hierarchyData)).arrayBuffer(),
      r = new Blob([n]).stream().pipeThrough(new DecompressionStream('gzip')),
      i = +t.dataset.refl,
      s = await new Response(r).json(),
      o = t.querySelector('ul'),
      a = document.createElement('ul');
    if (
      (a.classList.add('tsd-hierarchy'),
      Ze(a, s, i),
      o.querySelectorAll('li').length == a.querySelectorAll('li').length)
    )
      return;
    let l = document.createElement('span');
    l.classList.add('tsd-hierarchy-toggle'),
      (l.textContent = window.translations.hierarchy_expand),
      t.querySelector('h4 a')?.insertAdjacentElement('afterend', l),
      l.insertAdjacentText('beforebegin', ', '),
      l.addEventListener('click', () => {
        l.textContent === window.translations.hierarchy_expand
          ? (o.insertAdjacentElement('afterend', a),
            o.remove(),
            (l.textContent = window.translations.hierarchy_collapse))
  ...
  function Ze(t, e, n) {
    let r = e.roots.filter((i) => Ke(e, i, n));
    for (let i of r) t.appendChild(Pe(e, i, n));
  }
  function Pe(t, e, n, r = new Set()) {
    if (r.has(e)) return;
    r.add(e);
  ...
  J(X, 'a[data-toggle]');
  J(Z, '.tsd-accordion');
  J(Y, '.tsd-filter-item input[type=checkbox]');
  var Oe = document.getElementById('tsd-theme');
  Oe && be(Oe);
  var tt = new U();
  Object.defineProperty(window, 'app', { value: tt });
  ge();
  ke();
  Qe();
})();
