...
export type ContractContext = EthersContractContextV5<
  FiatTokenV1Test,
  FiatTokenV1TestMethodNames,
  FiatTokenV1TestEventsContext,
  FiatTokenV1TestEvents
>;
...
export type FiatTokenV1TestEvents =
  | 'Approval'
  ...
  | 'Unpause'
  | 'Upgraded';
export interface FiatTokenV1TestEventsContext {
...
export type FiatTokenV1TestMethodNames =
...
export interface FiatTokenV1Test {
  /**
   * Payable: false
   * Constant: true
