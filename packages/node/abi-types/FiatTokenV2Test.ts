...
export type ContractContext = EthersContractContextV5<
  FiatTokenV2test,
  FiatTokenV2testMethodNames,
  FiatTokenV2testEventsContext,
  FiatTokenV2testEvents
>;
...
export type FiatTokenV2testEvents =
  | 'Approval'
  ...
  | 'Unpause'
  | 'Upgraded';
export interface FiatTokenV2testEventsContext {
...
export type FiatTokenV2testMethodNames =
...
export interface FiatTokenV2test {
  /**
   * Payable: false
   * Constant: true
   ...
   * Type: function
   */
  name2(overrides?: ContractCallOverrides): Promise<string>;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
