...
export type ContractContext = EthersContractContextV5<
  DummyERC20,
  DummyERC20MethodNames,
  DummyERC20EventsContext,
  DummyERC20Events
>;
...
export type DummyERC20Events = 'Approval' | 'Transfer';
export interface DummyERC20EventsContext {
  Approval(...parameters: any): EventFilter;
  Transfer(...parameters: any): EventFilter;
}
export type DummyERC20MethodNames =
  | 'new'
  | 'allowance'
  | 'approve'
  | 'balanceOf'
