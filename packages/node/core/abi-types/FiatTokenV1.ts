...
export type ContractContext = EthersContractContextV5<
  FiatTokenV1,
  FiatTokenV1MethodNames,
  FiatTokenV1EventsContext,
  FiatTokenV1Events
>;
...
export type FiatTokenV1Events =
  ...
  | 'Unpause'
  | 'Upgraded';
export interface FiatTokenV1EventsContext {
...
export type FiatTokenV1MethodNames =
