...
export type ContractContext = EthersContractContextV5<
  IERC20Metadata,
  IERC20MetadataMethodNames,
  IERC20MetadataEventsContext,
  IERC20MetadataEvents
>;
...
export type IERC20MetadataEvents = 'Approval' | 'Transfer';
export interface IERC20MetadataEventsContext {
  Approval(...parameters: any): EventFilter;
  Transfer(...parameters: any): EventFilter;
}
export type IERC20MetadataMethodNames =
  | 'allowance'
  | 'approve'
  | 'balanceOf'
  | 'decimals'
