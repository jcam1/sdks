...
export type ContractContext = EthersContractContextV5<
  MinterAdmin,
  MinterAdminMethodNames,
  MinterAdminEventsContext,
  MinterAdminEvents
>;
...
export interface MinterAdminEventsContext {
...
export type MinterAdminMethodNames =
